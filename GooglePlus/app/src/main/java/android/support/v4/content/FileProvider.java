  ...
  extends ContentProvider
{
  ...
  private static HashMap<String, fq> c = new HashMap();
  private fq d;
  ...
  private static fq a(Context paramContext, String paramString)
  {
    fq localfq;
    synchronized (c)
    {
      localfq = (fq)c.get(paramString);
      if (localfq != null) {}
    }
    for (;;)
    {
      ...
      catch (IOException localIOException)
      {
        ...
        if ("root-path".equals(str1))
        {
          ...
          localfq.a(str2, (File)localObject2);
          continue;
        }
      }
