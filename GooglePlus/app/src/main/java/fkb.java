  ...
  implements fjz
{
  ...
  public fkb(IBinder paramIBinder)
  {
    this.a = paramIBinder;
  }
  ...
  public final com.google.android.gms.maps.model.Tile a(int paramInt1, int paramInt2, int paramInt3)
  {
    ...
    //   35: aload_0
    //   36: getfield 15	fkb:a	Landroid/os/IBinder;
    //   39: iconst_1
    //   40: aload 4
    //   42: aload 5
    //   44: iconst_0
    ...
    //   61: ifeq +31 -> 92
    //   64: getstatic 51	com/google/android/gms/maps/model/Tile:CREATOR	Lfkp;
    //   67: pop
    //   68: aload 5
    //   70: invokestatic 56	fkp:a	(Landroid/os/Parcel;)Lcom/google/android/gms/maps/model/Tile;
    //   73: astore 10
    //   75: aload 10
    //   77: astore 8
    //   79: aload 5
