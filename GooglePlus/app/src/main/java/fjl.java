...
public abstract class fjl
  ...
  implements fjk
{
  public static fjk a(IBinder paramIBinder)
  {
    ...
    if ((localIInterface != null) && ((localIInterface instanceof fjk))) {
      return (fjk)localIInterface;
    }
    return new fjm(paramIBinder);
  }
  ...
  public boolean onTransact(int paramInt1, Parcel paramParcel1, Parcel paramParcel2, int paramInt2)
  {
    ...
    case 9: 
      ...
      if (m != 0) {
        localLatLngBounds2 = fkf.a(paramParcel1);
      }
