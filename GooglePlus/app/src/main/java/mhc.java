...
public final class mhc
  ...
  implements pzf
{
  public static final mhc a = new mhc(pyr.c, pxz.b);
  private static volatile pzg c = null;
  private static volatile pzh<mhc> e;
  private static final long serialVersionUID;
  private byte d;
  
  /* Error */
  private mhc(pxw parampxw, pxz parampxz)
  {
    // Byte code:
    //   0: aload_0
    ...
    //   49: aload_2
    //   50: iload 8
    //   52: invokevirtual 61	mhc:a	(Lpzd;Lpxw;Lpxz;I)Z
    //   55: istore 9
    //   57: iload 9
    //   59: ifne +81 -> 140
    //   62: iconst_1
  ...
  {
    switch (mhd.a[(paramInt - 1)])
    {
    default: 
      throw new UnsupportedOperationException();
    case 1: 
      this = new mhc((pxw)paramObject1, (pxz)paramObject2);
    case 2: 
    case 3: 
    case 4: 
    case 5: 
    case 6: 
      ...
      mhc localmhc = (mhc)paramObject1;
      a(localmhc);
      pzs localpzs = localmhc.h;
