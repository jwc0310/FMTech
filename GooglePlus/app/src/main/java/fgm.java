  ...
  implements fgk
{
  ...
  fgm(IBinder paramIBinder)
  {
    this.a = paramIBinder;
  }
  
  /* Error */
  public final euz a(fjq paramfjq)
  {
    // Byte code:
    ...
    //   32: aload_0
    //   33: getfield 15	fgm:a	Landroid/os/IBinder;
    //   36: iconst_1
    //   37: aload_2
    //   38: aload_3
    //   39: iconst_0
    ...
    //   54: invokestatic 54	eva:a	(Landroid/os/IBinder;)Leuz;
    //   57: astore 7
    //   59: aload_3
  ...
  /* Error */
  public final euz b(fjq paramfjq)
  {
    // Byte code:
    //   0: invokestatic 22	android/os/Parcel:obtain	()Landroid/os/Parcel;
    //   3: astore_2
