  ...
  implements dd, de
{
  ...
  {
    this.c.add(ed.a(this.a, paramea));
  }
  
  public final Notification b()
  {
    Notification localNotification = this.a.build();
    Bundle localBundle1 = ed.a(localNotification);
    ...
    SparseArray localSparseArray = ed.a(this.c);
    if (localSparseArray != null) {
      ed.a(localNotification).putSparseParcelableArray("android.support.actionExtras", localSparseArray);
    }
