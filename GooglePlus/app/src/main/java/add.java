  ...
  implements tk
{
  ...
  public add(Context paramContext, AttributeSet paramAttributeSet)
  {
    this(paramContext, paramAttributeSet, aau.J);
  }
  
  private add(Context paramContext, AttributeSet paramAttributeSet, int paramInt)
  {
