  ...
  implements cs
{
  ...
  public final void a(String paramString1, int paramInt, String paramString2, android.app.Notification paramNotification)
  {
    ...
    //   12: aload 5
    //   14: aload_1
    //   15: invokevirtual 30	android/os/Parcel:writeString	(Ljava/lang/String;)V
    //   18: aload 5
    //   20: iload_2
    ...
    //   43: aload 5
    //   45: iconst_0
    //   46: invokevirtual 51	android/app/Notification:writeToParcel	(Landroid/os/Parcel;I)V
    //   49: aload_0
    //   50: getfield 15	cu:a	Landroid/os/IBinder;
    //   53: iconst_1
    //   54: aload 5
    //   56: aconst_null
    //   57: iconst_1
    //   58: invokeinterface 36 5 0
    //   63: pop
    //   64: aload 5
