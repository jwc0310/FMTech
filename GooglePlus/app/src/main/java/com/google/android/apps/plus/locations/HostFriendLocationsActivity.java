...
public class HostFriendLocationsActivity
  extends mbp
  implements gpq, gxv
{
  private final bhp d;
  ...
  {
    new idy(this, this.n, "android_location_gmh");
    new jyj(this, this.n);
 ...
 * Qualified Name:     com.google.android.apps.plus.locations.HostFriendLocationsActivity
