...
public class HostLocalCollectionTileActivity
  extends mbp
  implements gpq, gxv
{
  private final git d;
  ...
  public HostLocalCollectionTileActivity()
  {
 ...
 * Qualified Name:     com.google.android.apps.plus.phone.HostLocalCollectionTileActivity
