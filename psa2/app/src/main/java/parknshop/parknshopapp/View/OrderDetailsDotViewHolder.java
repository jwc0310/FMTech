 ...
 */
public class OrderDetailsDotViewHolder {
    LinearLayout view;
    ...
    public OrderDetailsDotViewHolder(LinearLayout view, int number, int status , Context context) {
        this.view = view;
    ...
    public OrderDetailsDotViewHolder(LinearLayout view, int number, int status , String text, Context context) {
        this.view = view;
        ButterKnife.bind(this, view);
    ...
    public OrderDetailsDotViewHolder(LinearLayout view, int number, int status , Context context, boolean isWatson) {
        this.view = view;
        ButterKnife.bind(this, view);
...
//        String[] tempString = context.getResources().getStringArray(R.array.check_out_dot_string);
        ...
        if(this.number == 6){
            drawablePath = "checkout_current_step";
            leftConnectionLine.setBackgroundColor(context.getResources().getColor(android.R.color.transparent));
            rightConnectionLine.setBackgroundColor(context.getResources().getColor(android.R.color.transparent));
        }
