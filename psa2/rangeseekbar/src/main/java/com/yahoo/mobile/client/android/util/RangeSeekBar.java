...
public class RangeSeekBar<T extends Number> extends ImageView {
    ...
    public static final int HEIGHT_IN_DP = 100;
    ...
    private final Bitmap seekLeftImage = BitmapFactory.decodeResource(getResources(), R.drawable.seek_left);

    private final Bitmap seekRightImage = BitmapFactory.decodeResource(getResources(), R.drawable.seek_right);
     ...
     */
    public static final int DEFAULT_COLOR = Color.argb(0xFF, 41, 45, 132);
    /**
    ...
    protected synchronized void onDraw(Canvas canvas) {
        ...
        if (!mSingleThumb) {
            drawThumb(normalizedToScreen(normalizedMinValue), Thumb.MIN.equals(pressedThumb), canvas, selectedValuesAreDefault, true);
        }

        // draw maximum thumb
        drawThumb(normalizedToScreen(normalizedMaxValue), Thumb.MAX.equals(pressedThumb), canvas, selectedValuesAreDefault, false);
        ...
        //if (!selectedValuesAreDefault) {
            ...
            String minText = "HK$" + String.valueOf(getSelectedMinValue())+"";
            String maxText = "HK$" + String.valueOf(getSelectedMaxValue())+"";
     ...
     */
    private void drawThumb(float screenCoord, boolean pressed, Canvas canvas, boolean areSelectedValuesDefault, boolean left) {
        Bitmap buttonToDraw;
        //if (areSelectedValuesDefault) {
        //    buttonToDraw = thumbDisabledImage;
        //} else {
            buttonToDraw = left ? seekLeftImage : seekRightImage;//pressed ? thumbImage : thumbImage;
       // }
