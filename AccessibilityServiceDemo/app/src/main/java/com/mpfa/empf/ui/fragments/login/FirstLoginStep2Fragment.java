...
public class FirstLoginStep2Fragment extends CommonBaseFragment implements View.OnClickListener{
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        mNewFirstPassword = (EditText)view.findViewById(com.mpfa.empf.R.id.et_new_first_password);
        mReNewFirstPassword = (EditText)view.findViewById(com.mpfa.empf.R.id.et_re_new_first_password);
        mNewSecondPassword = (EditText)view.findViewById(com.mpfa.empf.R.id.et_new_second_password);
        mReNewSecondPassword = (EditText)view.findViewById(com.mpfa.empf.R.id.et_re_new_second_password);
        mNextBtn = (Button)view.findViewById(com.mpfa.empf.R.id.btn_fisrt_login_step2_next);
        return view;
    }
    ...
    public int getLayoutRes() {
        return com.mpfa.empf.R.layout.fragment_first_login_step2;
    }
    ...
    public void onClick(View v) {
        if(com.mpfa.empf.R.id.btn_fisrt_login_step2_next == v.getId()){
            gotoNextStep();
        }
    }
