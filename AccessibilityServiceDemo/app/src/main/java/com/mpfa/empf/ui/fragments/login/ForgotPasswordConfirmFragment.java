...
public class ForgotPasswordConfirmFragment extends CommonBaseFragment implements View.OnClickListener{
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        mQuestion = (EditText)view.findViewById(com.mpfa.empf.R.id.et_forgot_pwd_confirm_question);
        mAnswer = (EditText)view.findViewById(com.mpfa.empf.R.id.et_forgot_pwd_confirm_answer);
        mSubmitBtn = (Button)view.findViewById(com.mpfa.empf.R.id.btn_forgot_pwd_confirm_submit);
        return view;
    }
    ...
    public int getLayoutRes() {
        return com.mpfa.empf.R.layout.fragment_forgot_password_confirmation;
    }
