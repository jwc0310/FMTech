...
public class DrawerAdapter extends BaseAdapter{
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        if(position == 0){
            return mInflater.inflate(com.mpfa.empf.R.layout.drawer_action_top_spacing, parent, false);
        }else {
            FMDrawerLayout.DrawerAction drawerAction = mDrawerActions.get(position - 1);
            TextView actionTextView;
            if (drawerAction.isActive) {
                actionTextView = (TextView) mInflater.inflate(com.mpfa.empf.R.layout.drawer_action_active, parent, false);
            } else {
                actionTextView = (TextView) mInflater.inflate(com.mpfa.empf.R.layout.drawer_action_regular, parent, false);
            }
