...
import com.mpfa.empf.ui.fragments.homepages.MessageBoxFragment;
import com.mpfa.empf.ui.component.ItemHomeTab;
import com.mpfa.empf.ui.fragments.homepages.HomeFragmentPagerAdapter;
import com.mpfa.empf.ui.fragments.homepages.PersonalAccountFragment;
import com.mpfa.empf.ui.fragments.homepages.PersonalProfileFragment;
import com.mpfa.empf.ui.fragments.homepages.TrusteeContactFragment;
...
public class HomeFragment extends PageFragment implements View.OnClickListener{
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        mPresonalAccountTab = (ItemHomeTab)view.findViewById(com.mpfa.empf.R.id.home_tab_personal_account);
        mTrusteeContactTab = (ItemHomeTab)view.findViewById(com.mpfa.empf.R.id.home_tab_trustee_contact);
        mMessageBoxTab = (ItemHomeTab)view.findViewById(com.mpfa.empf.R.id.home_tab_message_box);
        mPersonalProfileTab = (ItemHomeTab)view.findViewById(com.mpfa.empf.R.id.home_tab_personal_profile);
        mViewPager = (ViewPager)view.findViewById(com.mpfa.empf.R.id.home_viewpager);
...
//        mFragments.get(0).rebindActionBar();
    ...
    private void initTabs(){
        ...
        mPresonalAccountTab.setTabTitle(CommonResourceUtils.getString(com.mpfa.empf.R.string.fragment_title_personal_account));

        mTrusteeContactTab.setOnClickListener(this);
        mTrusteeContactTab.setMessageCount(0);
        mTrusteeContactTab.setTabTitle(CommonResourceUtils.getString(com.mpfa.empf.R.string.fragment_title_trustee_contact));

        mMessageBoxTab.setOnClickListener(this);
        mMessageBoxTab.setTabTitle(CommonResourceUtils.getString(com.mpfa.empf.R.string.fragment_title_message_box));

        mPersonalProfileTab.setOnClickListener(this);
        mPersonalProfileTab.setMessageCount(0);
        mPersonalProfileTab.setTabTitle(CommonResourceUtils.getString(com.mpfa.empf.R.string.fragment_title_personal_profile));
    ...
    public void onActivityCreated(@Nullable Bundle savedInstanceState) {
        ...
        mBreadcrumb = mContext.getString(com.mpfa.empf.R.string.app_name);
        rebindActionBar();
    }
    ...
    public void rebindActionBar() {
        ...
        mPageFragmentHost.updateCurrentBackendId(FragmentConfig.FRAGMENT_HOME -1, true);
    ...
    public int getLayoutRes() {
        return com.mpfa.empf.R.layout.fragment_home;
    }
    ...
    public void onClick(View v) {
        int currIndex = -1;
        switch (v.getId()){
            case com.mpfa.empf.R.id.home_tab_personal_account:
                currIndex = 0;
                break;
            case com.mpfa.empf.R.id.home_tab_trustee_contact:
                currIndex = 1;
                break;
            case com.mpfa.empf.R.id.home_tab_message_box:
                currIndex = 2;
                break;
            case com.mpfa.empf.R.id.home_tab_personal_profile:
                currIndex = 3;
                break;
        }
        if(currIndex != -1){
