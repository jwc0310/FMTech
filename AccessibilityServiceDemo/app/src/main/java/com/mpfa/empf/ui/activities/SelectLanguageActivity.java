...
public class SelectLanguageActivity extends BaseActivity implements View.OnClickListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(com.mpfa.empf.R.layout.activity_select_language);
        mBtnLanguageCN = (Button)findViewById(com.mpfa.empf.R.id.btn_language_cn);
        mBtnLanguageEN = (Button)findViewById(com.mpfa.empf.R.id.btn_language_en);
        initViews();
    }
    ...
    public void onClick(View v) {
        switch (v.getId()){
            case com.mpfa.empf.R.id.btn_language_cn:
                changeLanguage("CN");
                break;
            case com.mpfa.empf.R.id.btn_language_en:
                changeLanguage("EN");
                break;
        }
    }
