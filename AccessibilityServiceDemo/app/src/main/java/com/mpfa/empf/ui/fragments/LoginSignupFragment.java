...
import com.mpfa.empf.ui.activities.LoginActivity;
...
public class LoginSignupFragment extends PageFragment implements View.OnClickListener{
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        mLoginBtn = (Button)view.findViewById(com.mpfa.empf.R.id.login);
        mSignupBtn = (Button)view.findViewById(com.mpfa.empf.R.id.signup);
        return view;
    }
    ...
    public int getLayoutRes() {
        return com.mpfa.empf.R.layout.fragment_login_signup;
    }
    ...
    public void onClick(View v) {
        switch (v.getId()){
            case com.mpfa.empf.R.id.login:
                toLogin();
                break;
            case com.mpfa.empf.R.id.signup:
                toSignup();
                break;
        }
    }
