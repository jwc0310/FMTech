...
public class MtelToolbar extends FrameLayout{
    ...
    public void setCustomActionBtnImage(int resId){
        showCustomActionBtn();
        mCustomActionBtn.setBackground(getResources().getDrawable(resId));
    }

    public void hideCustomActionBtn(){
        mCustomActionBtn.setVisibility(View.GONE);
    }

    public void showCustomActionBtn(){
        mCustomActionBtn.setVisibility(View.VISIBLE);
    }
