...
public class ItemHomeTab extends RelativeLayout{
    ...
    protected void onFinishInflate() {
        ...
        mTabTitle = (TextView)findViewById(com.mpfa.empf.R.id.home_tab_title);
        mMessageReminder = (MessageReminder)findViewById(com.mpfa.empf.R.id.home_tab_message_reminder);
    }
