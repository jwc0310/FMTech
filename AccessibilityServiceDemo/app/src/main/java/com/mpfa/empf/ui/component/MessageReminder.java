...
public class MessageReminder extends LinearLayout{
    ...
    protected void onFinishInflate() {
        ...
        mMessageCount = (TextView)findViewById(com.mpfa.empf.R.id.home_tab_message_count);
        mMessagePlus = (TextView)findViewById(com.mpfa.empf.R.id.home_tab_message_plus);
    }
