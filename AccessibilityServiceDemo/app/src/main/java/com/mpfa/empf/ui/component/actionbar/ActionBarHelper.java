package com.mpfa.empf.ui.component.actionbar;
...
//    public MtelToolbar mToolbar;
    ...
    public ActionBarHelper(NavigationManager navigationManager, ActionBarController actionBarController, AppCompatActivity activity) {
        ...
        mToolbar = ((Toolbar) activity.findViewById(com.mpfa.empf.R.id.toolbar));
        mMtelToolbar = ((MtelToolbar) activity.findViewById(com.mpfa.empf.R.id.mtel_toolbar));
        mActivity = activity;
