...
import com.mpfa.empf.model.NewsInfo;
import com.mpfa.empf.ui.fragments.base.PageFragment;
import com.mpfa.empf.ui.activities.NewsDetailActivity;
import com.mpfa.empf.ui.adapter.NewsAdapter;
import com.mpfa.empf.ui.decorator.DividerItemDecoration;
...
public class NewsFragment extends PageFragment implements NewsAdapter.NewsItemClickListener {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        initData();
        mRecyclerList = (RecyclerView)view.findViewById(com.mpfa.empf.R.id.rv_news);
    ...
    public void onActivityCreated(@Nullable Bundle savedInstanceState) {
        ...
        mBreadcrumb = mContext.getString(com.mpfa.empf.R.string.fragment_title_news);
        rebindActionBar();
    }
    ...
    public int getLayoutRes() {
        return com.mpfa.empf.R.layout.fragment_news;
    }
