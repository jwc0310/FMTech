package com.mpfa.empf.ui.navigationmanager;
...
import com.mpfa.empf.ui.fragments.HomeFragment;
import com.mpfa.empf.ui.fragments.TutorialsFragment;
import com.mpfa.empf.ui.fragments.base.PageFragment;
import com.mpfa.empf.MainActivity;
import com.mpfa.empf.ui.fragments.ContactUsFragment;
import com.mpfa.empf.ui.fragments.FragmentConfig;
import com.mpfa.empf.ui.fragments.NewsFragment;
import com.mpfa.empf.ui.fragments.SecurityTipsFragment;
import com.mpfa.empf.ui.fragments.SettingFragment;
import com.mpfa.empf.utils.MainThreadStack;
...
//        }
    ...
    public PageFragment getActivePage(){
        return (PageFragment)mFragmentManager.findFragmentById(com.mpfa.empf.R.id.content_frame);
    }
...
//        mBackStack.removeAllElements();
    ...
    public final void showPage(int pageType, String url, Fragment fragment, boolean replaceTop, View ... sharedViews){
        ...
        fragmentTransaction.replace(com.mpfa.empf.R.id.content_frame, fragment);
        if (replaceTop) {
            popBackStack();
        }
