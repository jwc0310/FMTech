...
public class SedondPasswordFragment extends CommonBaseFragment implements View.OnClickListener{
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        mLoginBtn = (Button)view.findViewById(com.mpfa.empf.R.id.btn_second_pwd_login);
        return view;
    }
    ...
    public int getLayoutRes() {
        return com.mpfa.empf.R.layout.fragment_second_pwd;
    }
    ...
    public void onClick(View v) {
        switch (v.getId()){
            case com.mpfa.empf.R.id.btn_second_pwd_login:
