...
import com.mpfa.empf.ui.activities.SelectLoginModeActivity;
...
public class SelectLoginModeFragment extends CommonBaseFragment implements View.OnClickListener{
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        mOneTimePasswordBtn = (Button)view.findViewById(com.mpfa.empf.R.id.btn_one_time_password);
        mSecondPasswordBtn = (Button)view.findViewById(com.mpfa.empf.R.id.btn_second_password);
        return view;
    }
    ...
    public int getLayoutRes() {
        return com.mpfa.empf.R.layout.fragment_login_mode;
    }
    ...
    public void onClick(View v) {
        switch (v.getId()){
            case com.mpfa.empf.R.id.btn_one_time_password:
                gotoOnTimePassword();
                break;
            case com.mpfa.empf.R.id.btn_second_password:
                gotoSecondPassword();
                break;
        }
    }
