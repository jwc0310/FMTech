...
public class ToggleButton extends View{
	...
	public void setup(AttributeSet attrs) {
		...
		TypedArray typedArray = getContext().obtainStyledAttributes(attrs, com.mpfa.empf.R.styleable.ToggleButton);
		offBorderColor = typedArray.getColor(com.mpfa.empf.R.styleable.ToggleButton_offBorderColor, offBorderColor);
		onColor = typedArray.getColor(com.mpfa.empf.R.styleable.ToggleButton_onColor, onColor);
		spotColor = typedArray.getColor(com.mpfa.empf.R.styleable.ToggleButton_spotColor, spotColor);
		offColor = typedArray.getColor(com.mpfa.empf.R.styleable.ToggleButton_offColor, offColor);
		borderWidth = typedArray.getDimensionPixelSize(com.mpfa.empf.R.styleable.ToggleButton_borderWidth1, borderWidth);
		defaultAnimate = typedArray.getBoolean(com.mpfa.empf.R.styleable.ToggleButton_animate, defaultAnimate);
		typedArray.recycle();
