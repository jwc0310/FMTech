...
public class FirstLoginStep1Fragment extends CommonBaseFragment implements View.OnClickListener{
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        mAccountName = (EditText)view.findViewById(com.mpfa.empf.R.id.et_first_login_step1_account_name);
        mSkipBtn = (Button)view.findViewById(com.mpfa.empf.R.id.btn_fisrt_login_step1_skip);
        mNextBtn = (Button)view.findViewById(com.mpfa.empf.R.id.btn_fisrt_login_step1_next);
        return view;
    }
    ...
    public int getLayoutRes() {
        return com.mpfa.empf.R.layout.fragment_first_login_step1;
    }
    ...
    public void onClick(View v) {
        switch (v.getId()){
            case com.mpfa.empf.R.id.btn_fisrt_login_step1_skip:
                skipToNextStep();
                break;
            case com.mpfa.empf.R.id.btn_fisrt_login_step1_next:
                gotoNextStep();
                break;
        }
    }
