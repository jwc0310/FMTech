...
public class FirstLoginStep3Fragment extends CommonBaseFragment implements View.OnClickListener{
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        mQuestion1 = (EditText)view.findViewById(R.id.et_first_login_step3_security_question1);
        mQuestion1 = (EditText)view.findViewById(R.id.et_first_login_step3_security_question2);
        mQuestion1 = (EditText)view.findViewById(R.id.et_first_login_step3_security_question3);
        mQuestion1 = (EditText)view.findViewById(R.id.et_first_login_step3_security_answer1);
        mQuestion1 = (EditText)view.findViewById(R.id.et_first_login_step3_security_answer2);
        mQuestion1 = (EditText)view.findViewById(R.id.et_first_login_step3_security_answer3);
        mNextBtn = (Button)view.findViewById(R.id.btn_fisrt_login_step3_skip);
        mSkipBtn = (Button)view.findViewById(R.id.btn_fisrt_login_step3_next);
        return view;
    }
